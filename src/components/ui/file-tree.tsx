...
const Tree = forwardRef<HTMLDivElement, TreeViewProps>(
  (
    ...
    // Get all expandable items from elements to always expand them
    ...
    const [expandedItems, setExpandedItems] = useState<string[] | undefined>(
      initialExpandedItems || getAllExpandableItems(elements),
    );
    ...
    // Always expand all items when elements change
    useEffect(() => {
      if (elements) {
        const allExpandableItems = getAllExpandableItems(elements);
